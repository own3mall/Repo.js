                ...
                $.each(response.data.tree, function(i){
                    ...
                    $.each(arr, function(i){
                        ...
                        if(!exists){
                            ...
                            if(output !== first){
								var lastAppended = $('li.dir:last', output.find('ul li.back').parent());
								if(lastAppended.length){
									lastAppended.after($('<li class="dir"><a href="#" data-id="' + id + '">' + name +'</a></li>'));
								}else{
									output.find('ul li.back').after($('<li class="dir"><a href="#" data-id="' + id + '">' + name +'</a></li>'));
								}                                
                            } else {
								var lastAppended = $('li.dir:last', output.find('ul li').first().parent());
								if(lastAppended.length){
									lastAppended.after($('<li class="dir"><a href="#" data-id="' + id + '">' + name +'</a></li>'));
								}else{
